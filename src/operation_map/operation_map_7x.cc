...
instruction_parser_t lookup_77(H8Board* h8300h)
{
    ...
    return bh_msb ? h8instructions::bld::register_direct_parse
                  : nullptr; // BILD
}
...
instruction_parser_t lookup_7A(H8Board* h8300h)
{
    ...
    case 0x01: return h8instructions::add::immediate_l_parse;
    case 0x02: return h8instructions::cmp::immediate_l_parse;
