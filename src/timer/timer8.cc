...
uint8_t Timer8::read8(uint32_t address, uint8_t channel)
{
    switch (address) {
...
uint16_t Timer8::read16(uint32_t address, uint8_t channel)
{
...
void Timer8::write8(uint32_t address, uint8_t value, uint8_t channel)
{
    switch (address) {
...
void Timer8::write16(uint32_t address, uint16_t value, uint8_t channel)
{
