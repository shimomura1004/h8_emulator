...
TEST_F(CPUTestFix, shlr_b_2)
{
    ...
    EXPECT_EQ(this->h8->cpu.reg8(1).get(), 0b00101010);
    EXPECT_EQ(this->h8->cpu.ccr().c(), true);
}


TEST_F(CPUTestFix, shlr_w_1)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;
    ...
    EXPECT_EQ(this->h8->cpu.reg16(1).get(), 0b0101010101010101);
    EXPECT_EQ(this->h8->cpu.ccr().c(), false);
}

TEST_F(CPUTestFix, shlr_w_2)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;
...
TEST_F(CPUTestFix, shlr_l_1)
{
    ...
    EXPECT_EQ(this->h8->cpu.reg32(1).get(), 0b01010101010101010101010101010101);
    EXPECT_EQ(this->h8->cpu.ccr().c(), false);
}

TEST_F(CPUTestFix, shlr_l_2)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;
