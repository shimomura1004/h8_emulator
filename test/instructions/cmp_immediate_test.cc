...
TEST_F(CPUTestFix, cmp_immediate_l_ccr_z)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;
    ...
    this->dram->write8(2, 0x0f);
    this->dram->write8(3, 0x0f);
    this->dram->write8(4, 0x0f);
    this->dram->write8(5, 0x0f);
...
TEST_F(CPUTestFix, cmp_immediate_l_ccr_h)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;

    this->h8->cpu.reg32(0).set(0b01000000000000000000000000000000);
    this->dram->write8(0, 0x7a);
    this->dram->write8(1, 0x20);
    this->dram->write8(2, 0b00001000);
    this->dram->write8(3, 0b00000000);
    this->dram->write8(4, 0b00000000);
    this->dram->write8(5, 0b00000000);

    int ret = this->h8->execute_next_instruction();
    EXPECT_EQ(ret, 0);

    EXPECT_EQ(this->h8->cpu.reg32(0).get(), 0b01000000000000000000000000000000);
...
TEST_F(CPUTestFix, cmp_immediate_l_ccr_n_c)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;

    this->h8->cpu.reg32(0).set(0x10000000);
    this->dram->write8(0, 0x7a);
    this->dram->write8(1, 0x20);
    this->dram->write8(2, 0x20);
    this->dram->write8(3, 0x00);
    ...
    EXPECT_EQ(this->h8->cpu.reg32(0).get(), 0x10000000);
...
TEST_F(CPUTestFix, cmp_immediate_l_ccr_n_v)
{
    this->h8->cpu.pc() = DummyMCU::area2_start;

    this->h8->cpu.reg32(0).set(0x00);
    this->dram->write8(0, 0x79);
    this->dram->write8(1, 0x20);
    this->dram->write8(2, 0x80);
    this->dram->write8(3, 0x00);
    ...
    EXPECT_EQ(this->h8->cpu.reg32(0).get(), 0x00);
